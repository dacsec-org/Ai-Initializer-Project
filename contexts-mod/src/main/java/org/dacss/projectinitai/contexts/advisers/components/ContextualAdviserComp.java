package org.dacss.projectinitai.contexts.advisers.components;
/**/
/**/
...
public class ContextualAdviserComp<T> {
    ...
    public T updateContext(T userRequest, T aiResponse) {
        try {
            ...
            Notification.show(STR."Error updating context: \{updateContextExc.getMessage()}");
            return null;
        }
    }
    ...
    public T processUserInput(T userRequest) {
        try {
            ...
            Notification.show(STR."Error processing user input: \{processUserInputExc.getMessage()}");
            return null;
        }
    }
    ...
    public T processAIOutput(T aiResponse) {
        try {
            ...
            Notification.show(STR."Error processing AI output: \{processAIOutputExc.getMessage()}");
            return null;
        }
    }
