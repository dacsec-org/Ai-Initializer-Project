...
/**
 * <h1>{@link DynamicModelUnLoaderKernel}</h1>
 * <p>
 * Kernel class for unloading a model dynamically from the GPU.
 * </p>
 */
@Component
public class DynamicModelUnLoaderKernel {

    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(DynamicModelUnLoaderKernel.class);

    /**
     * {@link #DynamicModelUnLoaderKernel()}
     * 0-parameter constructor.
     */
    public DynamicModelUnLoaderKernel() {
    }
    ...
    public boolean unloadModel(byte[] modelData) {
        return unloadModelKernel(modelData);
    }
}
