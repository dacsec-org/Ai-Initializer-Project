...
public class ListModelsUtil {
    ...
    private static final Path LLM_DIRECTORY = Paths.get(System.getProperty("user.home"), ".ai-initializer-project", "models");
     ...
     *
     * @return A {@link Flux} of all models in the models directory.
     */
