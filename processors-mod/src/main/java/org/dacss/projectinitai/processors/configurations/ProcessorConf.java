package org.dacss.projectinitai.processors.configurations;
/**/
...
/**
 * <h1>{@link ProcessorConf}</h1>
 * <p>
 * This class is a configuration class that provides beans for the processors of the application.
 * </p>
 */
@Configuration
