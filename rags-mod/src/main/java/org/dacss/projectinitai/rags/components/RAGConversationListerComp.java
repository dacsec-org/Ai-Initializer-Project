...
/**
 * <h1>{@link RAGConversationListerComp}</h1>
 */
@Component
public class RAGConversationListerComp implements ApplicationRunner {

    private static final Logger log = LoggerFactory.getLogger(RAGConversationListerComp.class);
    /**
    ...
    public RAGConversationListerComp(RedisVectorStore store,
