...
class CustomTextFields extends Component {
     ...
     */
    render() {
        return (_jsxs("div", { children: [this.renderTextField(1), this.renderTextField(2), this.renderTextField(3), this.renderTextField(4), this.renderTextField(5), this.renderTextField(6)] }));
    }
}
