 ...
 */
class DiskGauge extends Component<DiskGaugeProps, DiskGaugeState> {
  private intervalId: NodeJS.Timeout | null = null;

  constructor(props: DiskGaugeProps) {
    super(props);
    this.state = {
      value: 0,
    };
   ...
   * Fetches the disk data from the reactive backend.
   */
  async fetchData() {
