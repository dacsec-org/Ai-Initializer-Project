 ...
 * <h1>{@link GpuGauge}</h1>
 */
class GpuGauge extends Component<GpuGaugeProps, GpuGaugeState> {
  private intervalId: NodeJS.Timeout | null = null;

  constructor(props: GpuGaugeProps) {
    super(props);
    this.state = {
      value: 0,
    };
   ...
   * Fetches the GPU data from the reactive backend.
   */
  async fetchData() {
    const data = await MetricsService.measure('gpu') as unknown as MetricData;
