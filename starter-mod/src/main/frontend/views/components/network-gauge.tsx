 ...
 */
class NetworkGauge extends Component<NetworkGaugeProps, NetworkGaugeState> {
  private intervalId: NodeJS.Timeout | null = null;

  constructor(props: NetworkGaugeProps) {
    super(props);
    this.state = {
      value: 0,
    };
   ...
   * Fetches the network data from the reactive backend.
   */
  async fetchData() {
    const data = await MetricsService.measure('network') as unknown as MetricData;
